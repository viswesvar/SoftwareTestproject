...
public class VertytextmyProfile {
  ...
  @Test
  public void testVertytextmyProfile() throws Exception {
    ...
    assertEquals("Mini Robotic Arm Dynamic Camera orientation", driver.findElement(By.xpath("//div[@id='content']/p[10]")).getText());
  }
//
  @After
